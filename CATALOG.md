...
25. **Thailand's Visa vertical opens (2 of 6, GOV-2602)**, via
    ...
    Executive Summary update above and the document's own VERIFICATION.md
    for the full sourcing record and every disclosed scoping/judgment call.
    **Thailand now at 2 of 6 verticals** (Taxes, Visa); Business Formation
    is in progress via a concurrent GOV-2601 child of the same research
    cycle, and DMV/Passport/National ID remain screened dead-end/backlog.
