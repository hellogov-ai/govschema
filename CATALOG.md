...
**14 jurisdictions** | **218 published schema documents** (per `tools/govschema-client/registry-index.json`) covering 6 verticals across government services globally.
...
|----------|----------|------------|
| **Passport** | 13/14 (93%) | **AE** not yet modelled (no Passport candidate sourced this cycle) |
| **DMV** | 13/14 (93%) | sub-process/edition expansion (CDL beyond US-CA, IDL beyond US/IE/GB); **AE** not yet modelled |
| **Business Formation** | 12/14 (86%) | sub-process expansion only (sole trader/partnership/LLP in CA/NZ/IE/IN); **KR, AE** not yet modelled |
| **Taxes** | 14/14 (100%) | sub-process expansion only (corporate tax: SG modelled GOV-1261, ZA Dormant/Micro-Business/Body-Corporate modelled GOV-1268/GOV-1275/GOV-1282; IE Form CT1, ZA's other 2 ITR14 Annexures still open) |
| **Visa** | 11/14 (79%) | **NL, ZA** — both confirmed dead ends (see below), not open work; **AE** not yet modelled |
| **National ID & Civic Documents** | 13/14 (93%) | none genuinely open (SG voter-reg is a confirmed non-gap); **AE** not yet modelled |
...
### Business Formation — Incorporation, LLC, Company Registration (12/14 jurisdictions)

Every jurisdiction except South Korea and the United Arab Emirates has at
least one Business Formation schema. GOV-1289's research rated KR's Business
Formation vertical **WEAK** (IROS/startbiz.go.kr both require certificate
login) — not an open candidate without new sourcing. UAE's Business
Formation vertical was likewise rated WEAK/login-gated in that same research
cycle and was not revisited this cycle. Remaining gaps in the other 12 are
sub-process expansions: sole trader/partnership/LLP forms in CA, NZ, IE, and
India (only SPICe+ company incorporation modelled so far); a standalone EIN
schema for the US (currently folded into
...
- **Scraping:** `find registry -mindepth 3 -maxdepth 3 -type d` (one entry
  ...
  `tools/govschema-client/registry-index.json` (218 entries, one per
  published version/edition).
- **Classification:** Vertical assigned based on schema id, title, and
  authority.
- **Jurisdiction:** ISO 3166-1 alpha-2 code (AE, AU, CA, DE, FR, GB, IE, IN,
  KR, NL, NZ, SG, US, ZA) — 14 jurisdictions tracked as of GOV-1297/GOV-1335
  (2026-07-05), up from the prior revision's 13.
...
Emirates opened as 14th jurisdiction) | Standards Engineer
